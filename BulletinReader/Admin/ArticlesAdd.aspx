<%@ Page Title="Add Article" Language="C#" AutoEventWireup="true" CodeBehind="ArticlesAdd.aspx.cs" Inherits="BulletinReader.Admin.ArticlesAdd" MasterPageFile="~/Layout.Master" Async="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div class="container">
        <div class="page-header">
            <h1>Add Article <small>Adds a new article into system</small></h1>
        </div>
